...
**Documenting life inside the defense cannon.**
...
PVKK: Planetenverteidigungskanonenkommandant is a single-player bunker simulation set during an interplanetary war. The player operates a planetary defense cannon from inside a control room, managing power, targeting systems, and firing procedures. The project is currently in pre-alpha, with development planned for 2027.

This devlog is for players and developers interested in focused simulation games, tactile interfaces, and indie game production.
...
- 🌱 **Bunker Operations** — Operate a large planetary defense cannon from an enclosed control room.
- ⚙️ **Manual Systems** — Manage power, targeting, aiming, and firing through physical controls.
- 🛰️ **Planetary Defense** — Respond to an interplanetary invasion threatening the Cooperative State of Antos.
- 📋 **Orders and Choices** — Follow command instructions while making decisions during defensive operations.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2956040/ss_19520cc7073e5447443480a35dd82d176d4a5b87.1920x1080.jpg?t=1778169430" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2956040/ss_4a0b7dbadbd1c63e55dddef75f63cf9ddbb0421e.1920x1080.jpg?t=1778169430" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2956040/ss_a970bcb399b54910fda740fff7fd7710495415c0.1920x1080.jpg?t=1778169430" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
